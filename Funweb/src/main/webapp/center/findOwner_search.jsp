...
// 				int pageListLimit = 10; 
				...
				ArrayList<FileBoardDTO> boardList = dao.selectBoardList2(startRow, listLimit, keyword);
...
<%-- 						<td><%=board.getDate() %></td> --%>
			...
			<div id="page_control">
			<%
			int boardListCount = dao.selectBoardListCount2(keyword); 
			...
			%>
				...
				<%} else { %>
					<a href="findOwner_search.jsp?keyword=<%=keyword %>&pageNum=<%=pageNum - 1%>">Prev</a>
				<%} %>
				...
				<%for(int i = startPage; i <= endPage; i++){%>
					...
					<%} else { %>
						<a href="findOwner_search.jsp?keyword=<%=keyword %>&pageNum=<%=i%>"><%=i%></a>
					<%} %>
				<%} %>
				...
				<%} else { %>
					<a href="findOwner_search.jsp?keyword=<%=keyword %>&pageNum=<%=pageNum + 1%>">Next</a>
				<%} %>
				<div id="table_search">
